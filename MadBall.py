...
pygame.init()
screen = pygame.display.set_mode((770, 640))
pygame.display.set_caption("MadBall")
...
class Menu():
    ...
    def update(self):
        ...
        while is_menu:
            ...
            text = self.font.render("MadBall", False, (100,100,100))
            ...
            screen.blit(highscore, (300,400 + (math.sin(time.time() * 7) * 3)))
            pygame.display.flip()
            self.handle_events()
